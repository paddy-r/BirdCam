...
class BirdCam(tk.Tk):
    ...
    def __init__(self, feed_index=FEED_INDEX_DEFAULT,
        ...
        # Image and video tools menu
        imageMenu = tk.Menu(self.menubar)
        self.menubar.add_cascade(label="Image and video", menu=imageMenu)
        imageMenu.add_command(label="Create video from images", command=self.OnCreateVideo)
    ...
    def OnSaveLocation(self):
        ...
        new_path = fd.askdirectory(parent=self, initialdir=APP_PATH,
                                   title='Please select a directory for saving general files')
        if new_path:
    ...
    def OnImageSettings(self):
        ...
        new_path = fd.askdirectory(parent=self, initialdir=APP_PATH,
                                   title='Please select a directory for saving images')
        if new_path:
    ...
    def OnVideoSettings(self):
        ...
        new_path = fd.askdirectory(parent=self, initialdir=APP_PATH,
                                   title='Please select a directory for saving videos')
        if new_path:
